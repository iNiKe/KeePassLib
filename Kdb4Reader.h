...
@property(nonatomic, strong) Kdb4Tree * _tree;
@property (nonatomic, assign) uint32_t fileVersion;
@property (nonatomic, strong) NSString *headerComment;
@property (nonatomic, strong) KdbPassword *password;
